...
export interface IAbstractGatewayRepository {
   ...
   */
  create_customer(name: string, cpf: string): Promise<ICustomerResponse>;
  /**
   * Find a customer by uuid
   * @param uuid - The uuid of the customer
   * @returns The customer
   */
  find_by_uuid_customer(uuid: string): Promise<ICustomerResponse>;
  /**
